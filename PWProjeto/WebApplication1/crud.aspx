		...
		<body>
			...
			<div class="page">
                ...
                <div class="endereco">
					...
					<asp:RequiredFieldValidator ID="RequiredFieldValidatorRua" runat="server" ControlToValidate="InputRua" ErrorMessage="Digite o nome de sua rua!" ForeColor="Red"></asp:RequiredFieldValidator>
